...
function toTaskRecordFromRow(row: TaskRow): TaskRecord {
  return {
    ...
    visionModelOverride: row.request_payload.visionModelOverride,
    translationModelOverride: row.request_payload.translationModelOverride,
    status: row.status,
...
function buildTaskRecord(
  ...
  return {
    ...
    visionModelOverride: request.visionModelOverride,
    translationModelOverride: request.translationModelOverride,
    status: reply.status,
