...
export function Sidebar() {
  return (
    <aside
      className="hidden md:flex flex-col h-screen p-8 overflow-y-auto bg-surface w-80 fixed left-0 top-0 border-r border-line font-label"
    >
      ...
      <div
        className="flex items-center gap-4 mb-10 p-4 bg-primary/5 rounded-2xl"
      >
        <div
          className="w-12 h-12 rounded-full border-2 border-surface overflow-hidden shadow-sm relative"
        >
          <Image
            alt="User Avatar"
      ...
      <nav className="flex-1 space-y-2">
        <a
          className="bg-primary/10 text-primary rounded-2xl px-5 py-4 flex items-center gap-4 font-bold transition-all"
          href="#"
        >
      ...
      <div className="mt-auto pt-6">
        <div className="bg-ivory p-5 rounded-2xl border border-line">
